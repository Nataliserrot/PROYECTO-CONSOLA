...
public class Calendario {
    ...
    public int obtenerDiaSemanaPrimerDiaMesNumero() { //AL ESTAR DECLARADO ARRIBA EN LA INSTANCIA (ATRIBUTO) SE QUITA EL STATIC Y LA DESCRIPCION DEL ATRIBUTO ENTRE LOS PARENTESIS
...
public static void imprimirMatriz(int[][] matriz, JTextArea txaContenido) {
        ...
        for(int i=0; i<matriz.length; i++) {
            for(int j=0; j<matriz[0].length; j++) {
                ...
                System.out.printf("%4d ", matriz[i][j]); //letra d es para un entero, un numero
                ...
                txaContenido.append(s);
                    ...
                    s = String.format("%4s ", " "); //letra s es para imprimir un caracter
                    txaContenido.append(s);
                }
