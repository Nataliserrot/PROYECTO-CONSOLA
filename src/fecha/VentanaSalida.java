...
public class VentanaSalida extends JFrame {
    ...
    public void personalizarTextArea() {
        ...
        contenedor.add(scrollpane); //Poner el scrollpane (txaContenido)SIEMPRE!!
    }
    ...
    public void personalizarVentana() {
        ...
        this.setSize(300, 200); //Poner un ancho y alto a la ventana
        this.setResizable(true); //true se redimensiona, false No se redimensiona
        this.setLocationRelativeTo(null);//Colocar la ventana en el centro de la pantalla
        this.setVisible(true); //Mostrar la ventana SIEMPRE!!
    }
